    ...
    <section className="py-20 bg-gradient-to-b from-white to-[#F9F9F9]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-20">
          ...
          {/* Regional Export Country Sequence */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
            <div className="bg-white p-5 rounded-2xl border-2 border-[#E5E5E5] shadow-xs">
              <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#F0F0F0]">
                <h4 className="font-black text-sm uppercase tracking-wider text-[#00AEEF]">Middle East &amp; Gulf</h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#F5F5F5] text-[#666666]">3 Markets</span>
              </div>
              <ul className="space-y-2 text-xs">
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇸🇦 Saudi Arabia</span>
                  <span className="text-[10px] text-[#888888]">Football</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇦🇪 UAE</span>
                  <span className="text-[10px] text-[#888888]">Al Felaij</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇱🇧 Lebanon</span>
                  <span className="text-[10px] text-[#888888]">Zebra</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border-2 border-[#E5E5E5] shadow-xs">
              <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#F0F0F0]">
                <h4 className="font-black text-sm uppercase tracking-wider text-[#ED028C]">Africa</h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#F5F5F5] text-[#666666]">8 Markets</span>
              </div>
              <ul className="space-y-2 text-xs">
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇸🇩 Sudan</span>
                  <span className="text-[10px] text-[#888888]">Al Karaama</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇿🇦 South Africa</span>
                  <span className="text-[10px] text-[#888888]">Zippy</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇨🇩 DR Congo</span>
                  <span className="text-[10px] text-[#888888]">Simba</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇳🇬 Nigeria</span>
                  <span className="text-[10px] text-[#888888]">The Goose</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇰🇪 Kenya • 🇪🇬 Egypt</span>
                  <span className="text-[10px] text-[#888888]">Splints</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border-2 border-[#E5E5E5] shadow-xs">
              <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#F0F0F0]">
                <h4 className="font-black text-sm uppercase tracking-wider text-[#059669]">Europe</h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#F5F5F5] text-[#666666]">3 Markets</span>
              </div>
              <ul className="space-y-2 text-xs">
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇷🇴 Romania</span>
                  <span className="text-[10px] text-[#888888]">Magia Bunicii</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇺🇦 Ukraine</span>
                  <span className="text-[10px] text-[#888888]">ReD MaC</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇭🇺 Hungary</span>
                  <span className="text-[10px] text-[#888888]">Industrial</span>
                </li>
              </ul>
            </div>
            ...
            <div className="bg-white p-5 rounded-2xl border-2 border-[#E5E5E5] shadow-xs">
              <div className="flex items-center justify-between pb-3 mb-3 border-b border-[#F0F0F0]">
                <h4 className="font-black text-sm uppercase tracking-wider text-[#6366F1]">Central Asia &amp; Americas</h4>
                <span className="text-[10px] font-bold px-2 py-0.5 rounded-full bg-[#F5F5F5] text-[#666666]">2 Markets</span>
              </div>
              <ul className="space-y-2 text-xs">
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇺🇿 Uzbekistan</span>
                  <span className="text-[10px] text-[#888888]">Ziynat Match</span>
                </li>
                <li className="flex items-center justify-between p-2 rounded bg-[#FAFAFA]">
                  <span>🇭🇳 Honduras</span>
                  <span className="text-[10px] text-[#888888]">Match Materials</span>
                </li>
              </ul>
            </div>
          </div>
